...
if __name__ == '__main__':
    ...
    # End-user input question; you are supposed to replease this text with you wanted one.
    EndUserInput = "Could you please tell me a TED talk about dogs?."

    # First, we try to drive the LLM to generate the description of ’what human would do’ in this situation.
    ...
    # In this step, we  use the generation model to produce the expressive behaviors
